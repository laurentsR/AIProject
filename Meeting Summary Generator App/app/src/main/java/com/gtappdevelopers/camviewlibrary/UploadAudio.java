...
public class UploadAudio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTV = findViewById(R.id.btnUpload);
    ...
    private void RequestPermissions() {
        ...
        ActivityCompat.requestPermissions(UploadAudio.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
